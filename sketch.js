...
var bowImg, arrowImg, green_balloonImg, red_balloonImg, pink_balloonImg ,blue_balloonImg, backgroundImg;
...
function redBalloon() {
  var red = createSprite(0,Math.round(random(20, 370)), 15, 16);
...
function blueBalloon() {
  ...
  var blue = createSprite(0,Math.round(random(15, 360)), 10, 10);
...
function greenBalloon() {
  ...
  var green = createSprite(0,Math.round(random(26, 371)), 14, 13);
